          ...
          <div className='row'>
            <div className='col-4'>
              ...
              <div>
                ...
                <a href='tel:+91 2342342332' className='mt-3 d-block mb-1 text-white'>
                +91 2342342332
                </a>
                <a href='mailto: carloslorapuma@gmail.com' className='mt-3 d-block mb-0 text-white'>
                 carloslorapuma@gmail.com
                </a>
            ...
            <div className='col-3'>
              ...
              <div className='footer-links d-flex flex flex-column'>
